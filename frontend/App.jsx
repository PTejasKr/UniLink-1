...
const MainLayout = ({ children }) => (
    <div className="min-h-screen flex flex-col bg-background relative app-shell-grid">
        <Navbar />
        <div className="flex-1 w-full max-w-[1536px] mx-auto px-4 sm:px-8 lg:px-12 pt-28 pb-16 flex gap-6 lg:gap-8 xl:gap-10">
            {/* Left Navigation */}
            <div className="hidden sm:block w-[88px] lg:w-[296px] shrink-0">
